                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-12 mb-3 mb-md-0 col-md-4 order-1 order-md-2 text-center">
                            <div class="site-logo">
                                <a href="index.php" class="js-logo-clone">E-Pharmacy Store</a>
                            </div>
                        </div>
                        ...
                        <div class="text-right col-6 col-md-4 order-3 order-md-3">
                            <div class="site-top-icons">
                                <ul>
                                <li><a href="http://localhost/medical3/admin/login.php"><button type="button"
                                                class="btn btn-outline-secondary">Admin Login</button></a></li>
